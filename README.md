...
6. Set up the service on linux to start upon startup. Copy the 'temp-sensor.service.example' file into the config directory. Rename it to 'temp-sensor.service'.

7. Edit the paths in the 'config/temp-sensor.service' file to match your desired python installation and where you cloned the repo for 'main.py'.

8. Start the service or restart the raspberry pi.
